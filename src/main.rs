            ...
            Some(hit) => {
                match hit.material {
                    obj::Material::Diffuse  => {
                        ...
                        (power_directional * 0.0 + power_positional * 255.0) as i32 // 点光源だけ
                    },
...
fn main() {
    let env = Env {
        ...
        spheres: vec![
            obj::sphere_new( 12.0,   0.0, -2.0, 2.0, obj::Material::Diffuse),
            obj::sphere_new( -4.0,  13.0,  9.0, 2.0, obj::Material::Diffuse),
            obj::sphere_new( 16.0,  -5.0, -2.0, 2.0, obj::Material::Diffuse),
            obj::sphere_new(  0.0,   4.0,  8.0, 2.0, obj::Material::Diffuse),
            obj::sphere_new(-13.0, -13.0, -4.0, 3.0, obj::Material::Diffuse),
            obj::sphere_new(-10.0, -16.0,  3.0, 2.0, obj::Material::Diffuse),
        ...
        planes: vec![
            obj::plane_new( 0.0,  0.0, -1.0, -20.0, obj::Material::Diffuse), // bottom
            obj::plane_new(-1.0,  0.0,  0.0, -25.0, obj::Material::Diffuse), // right wall
            obj::plane_new( 1.0,  0.0,  0.0, -25.0, obj::Material::Diffuse), // left wall
            obj::plane_new( 0.0, -1.0,  0.0, -25.0, obj::Material::Diffuse), // floor
            obj::plane_new( 0.0,  1.0,  0.0, -25.0, obj::Material::Diffuse), // ceil
        ]
    };
